...
abstract class HardwareItem : IEntityPrimaryProperties, IEntityAdditionalProperties
{
...
class Drill : HardwareItem, IDrill
{
...
class Ladder : HardwareItem, ILadder
{
...
class PaintBrush : HardwareItem, IPaintBrush
{
...
class Hammer : HardwareItem, IHammer
{
